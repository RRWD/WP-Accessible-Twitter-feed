...
// Add an option page
// Accessible Twitter Feed, forked from Twitter Feedfor Developers by Storm Consultancy (Liam Gladdy)
...
function wpacc_tdf_settings_output() {
	...
	// TO-DO: i18n of these strings, set for next release

	echo '<div class="wrap">';

		echo '<h1>oAuth Twitter Feed Settings</h1>';
